...
attr.forEach((x) => {
    x.link = 'https://element-plus.org/zh-CN/component/checkbox.html#checkbox-attributes';
});
event.forEach((x) => {
    x.link = 'https://element-plus.org/zh-CN/component/checkbox.html#checkbox-events';
});
exports.default = {
    key: 'el-checkbox',
    attr,
...
//# sourceMappingURL=el-checkbox.js.map